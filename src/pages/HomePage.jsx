      ...
      <div className="row">
        <div className="col-2 d-flex justify-content-center align-items-center ps-4">
          <img
            ...
            src={comment.image || `${BASE}assets/images/letter A.png`}
            alt=""
          />
        </div>
...
export default function HomePage() {
  ...
  const controlClass = (field) =>
    touched[field] ? (validation[field] ? "is-valid" : "is-invalid") : "";
  ...
  return (
    <>
      ...
      <header className="vh-100 d-flex justify-content-center align-items-center position-relative">
        <div>
          <h3 className="position-absolute translate-middle display-3 fw-bolder">
          ...
          <div className="icons mt-5 mb-3 d-flex justify-content-center">
            ...
            >
              <i className="fa-brands fa-facebook-f text-center fs-5 px-3" />
            </a>
            <a href="https://x.com/" className="text-decoration-none">
              <i className="fa-brands fa-twitter text-white text-center fs-5 px-3" />
            </a>
            <a
              href="https://www.linkedin.com/"
              className="text-decoration-none"
            >
              <i className="fa-brands fa-linkedin-in text-white text-center fs-5 px-3" />
            </a>
          ...
          <form onSubmit={handleCommentSubmit} noValidate>
            <div className="row gy-2">
              <div className="col-md-6">
                <input
                  type="text"
                  className={`form-control ${controlClass("name")}`}
                  placeholder="Name"
                  autoComplete="off"
                  value={form.name}
              ...
              <div className="col-md-6">
                <input
                  type="email"
                  className={`form-control ${controlClass("email")}`}
                  placeholder="E-mail"
                  autoComplete="off"
                  value={form.email}
